...
namespace OpenLiveWriter.CoreServices
{
	...
	public class DelayedCancellableSignal
	{
		...
		{
			Debug.WriteLine("Process Management: Will shut down in " + (new TimeSpan((long)(delay * 10000)).ToString()) + " unless new clients arrive");
			this.DoSignal(this.delay);
		}

		public void SignalNow()
		{
			Debug.WriteLine("Shutting down immediately");
			this.DoSignal(0.0);
		}
		...
		public void CancelAllSignals()
		{
			lock(lockObj)
			{
				...
				Debug.WriteLine( "New client arrived");
