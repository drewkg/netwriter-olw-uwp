...
namespace OpenLiveWriter.CoreServices
{
	public class StreamHelper
	{
		...
		public static Task<long> TransferAsync(Stream inStream, Stream outStream)
		{
			return TransferAsync(inStream, outStream, 8192, true);
		}

		public static async Task<long> TransferAsync(Stream inStream, Stream outStream, int bufferSize, bool flush)
		{
			...
			while(0 != (bytesRead = await inStream.ReadAsync(buffer, 0, bufferSize)))
			{
				if (bytesRead < 0)
				{
