    ...
    public class BlogClientOptions : IBlogClientOptions
    {
        ...
        public static IBlogClientOptions ApplyOptionOverrides(OptionReader optionReader, IBlogClientOptions existingOptions, bool includeIrregularities)
        {
            ...
            if (includeIrregularities)
            {
                ...
                clientOptions.AlwaysSendPostDate = ReadBool(optionReader("alwaysSendPostDate"), existingOptions.AlwaysSendPostDate);
            }
            else
            {
        ...
        public bool AlwaysSendPostDate { get; set; }
        ...
        internal static bool ReadBool(string boolValue, bool defaultValue)
        {
            ...
            if (string.IsNullOrWhiteSpace(boolValue)) return defaultValue;

            if (boolValue.ToLowerInvariant() == "no") return false;
            if (boolValue.ToLowerInvariant() == "yes") return true;

            if (bool.TryParse(boolValue, out foundresult))
            {
                return foundresult;
            }
            else
        ...
        private static int ReadInt(string intValue, int defaultValue)
        {
            if (intValue != null)
            {
                ...
                {
                   // Debug.Fail("Error parsing int string \"" + intValue + ": " + e.ToString());
                }
            }
            return defaultValue;
        }
        ...
        private int _postBodyBackgroundColor = 0;
        ...
        private Regex HompepageUrlRegex
        {
            get
            {
                if (_homepageUrlRegex == null && _homepageUrlPattern != String.Empty)
                {
                    ...
                    {
                        Debug.Fail("Invalid regular expression: " + _homepageUrlPattern);
                    }
                }
        ...
        private Regex HomepageContentRegex
        {
            get
            {
                if (_homepageContentRegex == null && _homepageContentPattern != String.Empty)
                {
                    ...
                    {
                        Debug.Fail("Invalid regular expression: " + _homepageContentPattern);
                    }
                }
        ...
        private Regex RsdEngineNameRegex
        {
            get
            {
                if (_rsdEngineNameRegex == null && _rsdEngineNamePattern != String.Empty)
                {
                    ...
                    {
                        Debug.Fail("Invalid regular expression: " + _rsdEngineNamePattern);
                    }
                }
        ...
        private Regex RsdHomepageLinkRegex
        {
            get
            {
                if (_rsdHomepageLinkRegex == null && _rsdHomepageLinkPattern != String.Empty)
                {
                    ...
                    {
                        Debug.Fail("Invalid regular expression: " + _rsdHomepageLinkPattern);
                    }
                }
