...
namespace OpenLiveWriter.CoreServices
{
    ...
    public class XmpMetadata
	{
		...
		public string[] Keywords
		{
			...
			{
				// get keywords
				IXmlNode xmlNode = doc.SelectSingleNodeNS("/rdf:RDF/rdf:Description/dc:subject/rdf:Bag", NamespaceManager.ToNSMethodFormat());
				ArrayList keywords = new ArrayList();
				if (xmlNode != null)
				{
					foreach (var li in xmlNode.ChildNodes)
					{
		...
		public int Rating
		{
			...
			{
				// get ratings
				var xmlNode = doc.SelectSingleNodeNS("/rdf:RDF/rdf:Description/xap:Rating", NamespaceManager.ToNSMethodFormat());
				...
				if (xmlNode == null)
				{
					xmlNode = doc.SelectSingleNodeNS("/rdf:RDF/rdf:Description", NamespaceManager.ToNSMethodFormat());
					xmlNode = xmlNode.Attributes.GetNamedItem("xap:Rating");
				}
