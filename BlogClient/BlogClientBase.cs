	...
	public abstract class BlogClientBase
	{
	    ...
	    public string ProtocolName
	    {
	        get
	        {
                ...
                //{
                //    Debug.Fail("BlogClientAttribute not found on type " + GetType().FullName);
                //    return null;
                //}
		...
		/// </summary>
		/// <returns></returns>
		protected virtual Task<TransientCredentials> Login()
		{
			...
			return Task.FromResult(transientCredential);
		}
		...
		/// </summary>
		/// <param name="tc"></param>
		protected abstract Task VerifyCredentials(TransientCredentials tc);
	}
}
