...
namespace MimeTypes
{
    public static class MimeTypeMap
    {
        ...
        public static string GetMimeType(string extension, string defaultValue = null)
        {
            if (extension == null)
            {
            ...
            return _mappings.Value.TryGetValue(extension, out mime) ? mime : defaultValue ?? "application/octet-stream";
        }
